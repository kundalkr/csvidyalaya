...
})({"czZGs":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "9fe353f1c7b4f78e";
"use strict";
...
},{}],"4nonz":[function(require,module,exports,__globalThis) {
var _utilitiesMinJs = require("/js/src/utilities.min.js");
function loadScript(e, t) {
    const n = document.createElement("script");
    n.src = e, n.type = "module", n.onload = t, document.head.appendChild(n);
}
function last_modified() {
    let e = new Date(document.lastModified).toDateString().split(" "), t = document.querySelector("#title-date > h1"), n = document.createElement("div");
    n.setAttribute("id", "last-updated-parent"), n.innerHTML = `<div><span>Last updated : </span><span>${e[1] + " " + e[2] + ", " + e[3]}</span></div><hr><div class="d-flex justify-content-between align-items-center border border-2"><div>\n<p style="margin:0;" class="m-0 fw-bold"> Like & Follow </p> </div><div>\n<a style="font-size: xx-large;"href="https://www.facebook.com/csvidyalaya1/"><i class="bi bi-facebook"></i></a> \n&nbsp;<a style="font-size: xx-large;color: brown;" href="https://www.instagram.com/csvidyalaya/"><i class="bi bi-instagram"></i></a>&nbsp;\n<a style="font-size: xx-large;color: black;" href="https://www.x.com/csvidya1aya/"><i class="bi bi-twitter-x"></i></a>&nbsp;\n<a href="https://t.me/+0y7RpzVA1nhlYzk9" style="font-size: xx-large;color: blue; class="btn btn-success " target="_blank"><i class="bi bi-telegram"></i></a>\n</div></div>`, t.insertAdjacentElement("afterend", n);
}
function css_files() {
...
function bar(e) {
    ...
    for (const t of e.users)n += `<a class="text-black text-decoration-underline scroll-item" style="text-decoration-color: rgb(255, 255, 255);text-decoration-thickness: 0.3ex;text-underline-offset: 0.3ex;"   href="${t.link}">${t.name}</a>`;
    t.innerHTML = '<div\n        id="bar1"\n        class="scroll-container scrollable"\n      >\n      <button class="scroll-left" onclick="scrollLefti()" style="position:fixed;left:5px">&#9664;</button>\n      ' + n + '<button class="scroll-right" onclick="scrollRight()" style="position:fixed;right:5px">&#9654;</button></div>', document.querySelector("#fheader").insertAdjacentElement("afterend", t);
}
loadScript("/js/src/for_all_page.min.js", ()=>{
    loadScript("/js/src/hdr_ftr.min.js", ()=>{
        founder_schemas(), css_files(), last_modified(), bar(bar_links), published_data();
    });
});
let leftandright = document.createElement("script");
leftandright.innerHTML = "function scrollLefti() {\n    document.querySelector('.scrollable').scrollBy({\n        left: -150, \n        behavior: 'smooth' \n    });\n};\nfunction scrollRight() {\n    document.querySelector('.scrollable').scrollBy({\n        left: 150, \n        behavior: 'smooth' \n    });\n}", (0, _utilitiesMinJs.add_head)(leftandright);

},{"/js/src/utilities.min.js":"1at8W"}],"1at8W":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "add_head", ()=>add_head);
parcelHelpers.export(exports, "add_css", ()=>add_css);
parcelHelpers.export(exports, "adding_div_child", ()=>adding_div_child);
parcelHelpers.export(exports, "add_body", ()=>add_body);
parcelHelpers.export(exports, "popup_links", ()=>popup_links);
parcelHelpers.export(exports, "google_font", ()=>google_font);
parcelHelpers.export(exports, "book_name_recommender", ()=>book_name_recommender);
parcelHelpers.export(exports, "sdbar_Links", ()=>sdbar_Links);
parcelHelpers.export(exports, "sequence_function_call", ()=>sequence_function_call);
function add_head(e) {
    document.querySelector("head").appendChild(e);
}
function add_css(e) {
    let t = document.createElement("style");
    t.innerHTML = `${e}`, add_head(t);
}
function adding_div_child(e) {
    document.createElement("div").innerHTML = `${e}`;
}
function add_body(e) {
    document.querySelector("body").appendChild(e);
}
function popup_links(e) {
    let t = document.createElement("div"), n = "";
    for (const t of e.users)n += `<li class="list-group-item" style="background-color: #FFD1DC;"><a href="${t.link}">${t.name}</a></li>`;
    t.innerHTML = '<div class="modal fade" id="myModal" tabindex="-1" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">\n        <div class="modal-dialog modal-dialog-centered">\n            <div class="modal-content">\n                <div class="modal-header">\n                    <h5 class="modal-title" id="exampleModalLabel">Also try these question</h5>\n                    <button type="button" id="btn_closeder" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>\n                </div>\n                <div class="modal-body">\n                       <ul class="list-group list-group-flush">' + n + "</ul></div></div></div></div>", add_body(t);
    let o = document.createElement("script");
    o.innerHTML = " \n function openModal() {\n            var myModal = new bootstrap.Modal(document.getElementById('myModal'));\n            myModal.show();\n        }\n            setTimeout(openModal, 10000);\n            document.getElementById('btn_closeder').addEventListener('click',() => setTimeout(openModal, 12 * 60 * 1000));\n    ", add_body(o);
}
function google_font(e) {
    for (const t of e.users){
        let e = document.createElement("link");
        e.setAttribute("href", `${t.link}`), e.setAttribute("rel", "stylesheet"), add_head(e);
    }
}
...
function book_name_recommender(e) {
    let t = "";
    for (let n of e.books)if (n.file_name.includes(`${file_name_viewer()}`)) for (let e of n.book)t += `<a href="${e.book_link}"><img loading="lazy" class="w-100 h-auto p-2"  src="${e.book_image}" alt="${e.image_alt}"/></a>`;
    if (1 == window.location.pathname.includes("scheduling-algorithms")) {
        if (window.innerWidth <= 1e3) document.querySelector("#three-section #book-recommendation > div.w-100").innerHTML = `${t}`;
        else document.querySelector("#right-content > #book-recommendations > div").innerHTML = `${t}`;
    }
    if (1 == window.location.pathname.includes("Assignment-templates")) document.querySelector("#left-side").innerHTML = `${t}`;
}
function sdbar_Links(e) {
    let t = document.querySelector("#left-content > ul");
    for (const n of e.users)t.innerHTML += `<li style="list-style: none;">\n    <a style="text-decoration: none;" href="${n.link}">${n.name}</a>\n    </li>`;
}
function sequence_function_call(...e) {
...
},{}]},["czZGs","4nonz"], "4nonz", "parcelRequire095d", {})

//# sourceMappingURL=csvidyalaya.c7b4f78e.js.map
