...
linked_services
    ...
    <br>
`;document.querySelector('body').prepend(a);let b=document.createElement('div');b.style.backgroundColor='#FFD1DC';b.innerHTML=`
       <div class="container">
      <footer
...
`;document.querySelector('body').append(b);window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/mlfqs.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/mlfqs.html');window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/MLQS.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/MLQS.html');let c=document.createElement('link');c.setAttribute('rel','stylesheet');c.setAttribute('href','https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css');add_head(c);let d=document.createElement('script');d.src='https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js';d.setAttribute('integrity','sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4');d.setAttribute('crossorigin','anonymous');add_head(d);
