import {add_head as a} from'/js/src/utilities.min.js';let b=document.createElement('div');b.setAttribute('id','fheader');b.innerHTML=`
...
`;document.querySelector('body').prepend(b);let c=document.createElement('div');c.style.backgroundColor='#FFD1DC';c.innerHTML=`
       <div class="container">
      <footer
...
`;document.querySelector('body').append(c);window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/mlfqs.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/mlfqs.html');window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/MLQS.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/MLQS.html');let d=document.createElement('link');d.setAttribute('rel','stylesheet');d.setAttribute('href','https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css');a(d);let e=document.createElement('script');e.src='https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js';e.setAttribute('integrity','sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4');e.setAttribute('crossorigin','anonymous');a(e);
