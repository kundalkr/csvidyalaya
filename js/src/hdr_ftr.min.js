...
linked_services
    ...
    <br>
`;document.querySelector('body').prepend(a);var b=document.createElement('div');b.style.backgroundColor='#FFD1DC';b.innerHTML=`
       <div class="container">
      <footer
...
`;document.querySelector('body').append(b);window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/mlfqs.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/mlfqs.html');window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/MLQS.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/MLQS.html');function c(){document.getElementById('sidebar').style.display='block'}function d(){document.getElementById('sidebar').style.display='none'}
