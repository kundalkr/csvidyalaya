import{add_head}from"/js/src/utilities.min.js";let header=document.createElement("div"),footer=(header.setAttribute("id","fheader"),header.innerHTML=`
...
`,document.querySelector("body").prepend(header),document.createElement("div")),bootstrapScript=(footer.style.backgroundColor="#FFD1DC",footer.innerHTML=`
       <div class="container">
      <footer
...
`,document.querySelector("body").append(footer),0===window.location.href.indexOf("https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/mlfqs.html")&&(window.location.href="https://csvidyalaya.com/os/scheduling_algorithms/mlfqs.html"),0===window.location.href.indexOf("https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/MLQS.html")&&(window.location.href="https://csvidyalaya.com/os/scheduling_algorithms/MLQS.html"),document.createElement("script"));if(bootstrapScript.src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js",bootstrapScript.setAttribute("integrity","sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4"),bootstrapScript.setAttribute("crossorigin","anonymous"),add_head(bootstrapScript),window.innerWidth<=900){let a=document.createElement("script");a.innerHTML=`function d() {
