...
`;document.querySelector('body').append(c);window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/mlfqs.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/mlfqs.html');window.location.href.indexOf('https://csvidyalaya.com/sub_modules/os/scheduling_algorithms/MLQS.html')===0&&(window.location.href='https://csvidyalaya.com/os/scheduling_algorithms/MLQS.html');let d=document.createElement('script');d.src='https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js';d.setAttribute('integrity','sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4');d.setAttribute('crossorigin','anonymous');a(d);if(window.innerWidth<=815){let A=document.createElement('script');A.innerHTML=`function d() {
