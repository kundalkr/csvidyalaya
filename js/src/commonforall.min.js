import {add_body as a,add_head as b} from'/js/src/utilities.min.js';let c=document.createElement('div');c.innerHTML=`
     <div
      class="modal fade"
      id="myModal"
      tabindex="-1"
...
`;a(c);let d=document.createElement('script');d.innerHTML=` 
          function openModal() {
