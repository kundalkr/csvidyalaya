import{add_head,google_font}from"/js/src/utilities.min.js";let bootstrapcss=document.createElement("link"),cssstyle=(bootstrapcss.setAttribute("href","https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css"),bootstrapcss.setAttribute("rel","stylesheet"),bootstrapcss.setAttribute("integrity","sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH"),bootstrapcss.setAttribute("crossorigin","anonymous"),add_head(bootstrapcss),document.createElement("style")),gfont=(cssstyle.innerHTML=`
