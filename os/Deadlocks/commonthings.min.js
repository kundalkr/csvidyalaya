 ...
 `;c(d);let e=document.createElement('div');e.innerHTML=`<div
  ...
  <a href="/Digital_Fundamentals/Boolean_Algebra/booleanalgebra1.html">Boolean algebra question</a>
   <a href="/dsa_in_c/dsa_in_c_topic.html">Dsa question </a>
    ...
    <br>`;let f=document.querySelector('body');f.insertBefore(e,document.querySelector('body>div'));a('ul>li>a{color: black} button#down{ background-color: #00FF40;a{color: black; }}');let g=document.createElement('div');g.innerHTML=`
...
`;b(g);window.onload=()=>{let A=document.createElement('script');A.innerHTML=` 
          function openModal() {
