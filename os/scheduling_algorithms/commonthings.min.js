import {add_css as a,add_body as b,add_head as c} from'/js/src/utilities.min.js';a('ul>li>a{color: black} button#down{ background-color: #00FF40;a{color: black; }}');let d=document.createElement('div');d.style.padding='0px 12px';d.innerHTML=`
<br>
   <div class="card" style="width: 18rem">
      ...
      <br>
`;let e=document.getElementById('question1');e.appendChild(d);let f=document.querySelector('div#this.card-header');f.style.color='white';f.style.backgroundColor='#0A0AFF';f.style.fontWeight='bold';let g=document.querySelectorAll('#question1 > div:nth-child(3) > div > ul>li');for(let A=0;A<g.length;A++)g[A].style.backgroundColor='#1AFF53';let h=document.createElement('div');h.innerHTML=`
...
`;b(h);window.onload=()=>{let _=document.createElement('script');_.innerHTML=` 
          function openModal() {
     ...
     `;b(_)};let i=document.createElement('style');i.innerHTML=`   
      #bar1 {
      a {
 ...
 `;c(i);let j=document.createElement('div');j.innerHTML=`<div
      id="bar1"
      style="
    ...
    </div>     <br>`;let k=document.querySelector('#fheader');k.appendChild(j);
