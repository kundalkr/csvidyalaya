let a=document.createElement('div');a.style.padding='0px 12px';a.innerHTML=`
...
<br>
   <div class="card" style="width: 18rem">
      ...
      <br>
`;let b=document.getElementsByClassName('question');b[0].append(a);let c=document.querySelector('div#this.card-header');c.style.color='white';c.style.backgroundColor='#0A0AFF';c.style.fontWeight='bold';let d=document.querySelector('.list-group .list-group-flush');d.style.backgroundColor='red';
