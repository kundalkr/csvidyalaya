import {add_css as a,add_body as b,add_head as c} from'/js/src/utilities.min.js';let d=document.createElement('style');d.innerHTML=`   
      #bar1 {
      a {
 ...
 `;c(d);let e=document.createElement('div');e.innerHTML=`<div
      id="bar1"
      style="
    ...
    </div>     <br>`;let f=document.querySelector('body');f.insertBefore(e,document.querySelector('body>div'));a('ul>li>a{color: black} button#down{ background-color: #00FF40;a{color: black; }}');let g=document.createElement('div');g.style.padding='0px 12px';g.innerHTML=`
<br>
   <div class="card" style="width: 18rem">
      ...
      <br>
`;let h=document.getElementById('question1');h.appendChild(g);let i=document.querySelector('div#this.card-header');i.style.color='white';i.style.backgroundColor='#0A0AFF';i.style.fontWeight='bold';let j=document.querySelectorAll('#question1 > div:nth-child(3) > div > ul>li');for(let A=0;A<j.length;A++)j[A].style.backgroundColor='#1AFF53';let k=document.createElement('div');k.innerHTML=`
...
`;b(k);window.onload=()=>{let _=document.createElement('script');_.innerHTML=` 
          function openModal() {
