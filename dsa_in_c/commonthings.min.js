import {add_body as a} from'/js/src/utilities.min.js';let b=document.createElement('div');b.style.border='1px solid red';b.innerHTML=`
...
`;let c=document.getElementsByClassName('question');for(let A=0;A<=c.length;A++){A==0&&c[A].insertBefore(b,c[A].firstChild);A%2==0&&c[A].insertBefore(b,c[A].firstChild)}let d=document.createElement('div');d.innerHTML=`
...
`;a(d);let e=document.createElement('script');e.innerHTML=` 
 function openModal() {
