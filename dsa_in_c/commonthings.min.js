import {add_body as a,add_head as b} from'/js/src/utilities.min.js';let c=document.createElement('style');c.innerHTML=`   
      #bar1 {
      a {
 ...
 `;b(c);let d=document.createElement('div');d.innerHTML=`<div
      id="bar1"
      style="
    ...
    </div>     <br>`;let e=document.querySelector('body');e.insertBefore(d,document.querySelector('body>div'));let f=document.createElement('div');f.innerHTML=`
...
`;let g=document.getElementsByClassName('question');for(let A=0;A<=g.length;A++){A==0&&g[A].insertBefore(f,g[A].firstChild);A%2==0&&g[A].insertBefore(f,g[A].firstChild)}let h=document.createElement('div');h.innerHTML=`
...
`;a(h);let i=document.createElement('script');i.innerHTML=` 
 function openModal() {
